# -*- coding: utf-8 -*-
#
# BFV widget documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 02 Dec 2015 23:50:33 +0100.
#
...
project = u'BFV widget'
copyright = u'2015, Thomas Off'
...
htmlhelp_basename = 'retiolumbfvwidgetdoc'
...
latex_documents = [
    ('Index', 'retiolumbfvwidget.tex', u'BFV widget',
     u'Thomas Off', 'manual'),
]
...
pdf_documents = [
    ('Index', 'retiolumbfvwidget', u'BFV widget',
     u'Thomas Off'),
]
...
texinfo_documents = [
    ('Index', 'retiolumbfvwidget', u'BFV widget',
     u'Thomas Off', 'BFV widget', 'One line description of project.',
     'Miscellaneous'),
]
